...
def get_params():
    params = {
        'weight': 'E:/yolov8-20240111/yolov8-main/runs/train/yolov8-SE5/weights/best.pt',
        'cfg': 'E:/yolov8-20240111/yolov8-main/ultralytics/cfg/models/v8/yolov8-GhostHGNetV2.yaml',
        'device': 'cuda:0',
